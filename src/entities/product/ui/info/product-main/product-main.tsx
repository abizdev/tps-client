...
const ProductCategoryTags = React.lazy(() => import('./product-category-tags'))
  ...
  return (
    <section className={cn('product-section-wrapper flex gap-3 md:gap-5')}>
      ...
      <div>
        ...
        <ProductWeights weights={product.weights} activeWeight={activeWeight} setActiveWeight={setActiveWeight} />
